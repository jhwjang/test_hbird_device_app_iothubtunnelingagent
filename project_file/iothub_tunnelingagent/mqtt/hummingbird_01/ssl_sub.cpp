...
// const std::string SERVER_ADDRESS("tcp://34.225.247.178:1883");
//const std::string SERVER_ADDRESS("ssl://mostest.gaialab.co.kr:443");
const std::string SERVER_ADDRESS("ssl://hummingbird.gaialab.co.kr:443");
const std::string CLIENT_ID("User_3");
const std::string TOPIC("HC");
// const char* LWT_PAYLOAD = "Last will and test sub.";
...
int main(int argc, char* argv[])
{
	...
	mqtt::connect_options connopts("mosquitto", "openwd");
	connopts.set_keep_alive_interval(20);
	// connopts.set_clean_session(true);
