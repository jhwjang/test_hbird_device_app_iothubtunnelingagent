...
const std::string DFLT_SERVER_ADDRESS	{ "ssl://mostest.gaialab.co.kr:443" };
const std::string DFLT_CLIENT_ID		{ "camera" };

// const std::string TOPIC { "HC" };
const std::string TOPIC("HDC");

const char* PAYLOAD1 = "Hello World :";
const char* PAYLOAD2 = "Hi there!!!!!!!!!!!!!!!!!!!!!!!!!1!";

const char* LWT_PAYLOAD = "Last will and test pub.";
...
int main(int argc, char* argv[])
{
	...
	try {
		...
		cout << "retain : "<<pubmsg->is_retained() << endl;
